...
public class MorphingButton extends AppCompatButton {
	...
	private void morphWithAnimation(@NonNull final Params params) {
		...
		MorphingAnimation.Params animationParams =
				MorphingAnimation.Params.create(this).color(mColor, params.color)
						...
						.height(getHeight(), params.height).width(getWidth(), params.width)
						.duration(params.duration).listener(new MorphingAnimation.Listener() {
	...
	private void initView() {
		...
		background.addState(new int[]{android.R.attr.state_pressed},
				mDrawablePressed.getGradientDrawable());
